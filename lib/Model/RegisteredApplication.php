...
/**
 * RegisteredApplication Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class RegisteredApplication implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RegisteredApplication';
    ...
    */
     ...
     * Sets pre_app_id
     *
     * @param int $pre_app_id Identifier to track the application registration from the App Registration and Get App Registration Status APIs, represented as a number
     *
     * @return self
     */
