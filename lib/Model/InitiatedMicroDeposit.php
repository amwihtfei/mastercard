...
/**
 * InitiatedMicroDeposit Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InitiatedMicroDeposit implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InitiatedMicroDeposit';
    ...
    */
     ...
     * Sets account_id
     *
     * @param string|null $account_id An account ID
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string|null $status Micro entries successful initiation status
     *
     * @return self
     */
     ...
     * Sets deposit_count
     *
     * @param int|null $deposit_count Count of micro entries
     *
     * @return self
     */
     ...
     *
     * @param string|null $status_description Micro entries successful initiation description
     *
     * @return self
     */
