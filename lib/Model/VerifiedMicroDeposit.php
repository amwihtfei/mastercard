...
/**
 * VerifiedMicroDeposit Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class VerifiedMicroDeposit implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VerifiedMicroDeposit';
    ...
    */
     ...
     * Sets status
     *
     * @param string|null $status Micro entries successful verification status
     *
     * @return self
     */
     ...
     *
     * @param string|null $status_description Micro entries successful verification description
     *
     * @return self
     */
