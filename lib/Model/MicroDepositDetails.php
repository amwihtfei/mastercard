...
/**
 * MicroDepositDetails Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class MicroDepositDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MicroDepositDetails';
    ...
    */
     ...
     *
     * @param string|null $status_description Micro entries status description
     *
     * @return self
     */
     ...
     * Sets creation_date
     *
     * @param string|null $creation_date A date-time without time zone
     *
     * @return self
     */
     ...
     * Sets routing_number
     *
     * @param string|null $routing_number Routing number of receiving bank
     *
     * @return self
     */
     ...
     *
     * @param string|null $account_number_last4 The last 4 digits of the ACH account number
     *
     * @return self
     */
    public function setAccountNumberLast4($account_number_last4)
    {
        if (is_null($account_number_last4)) {
            throw new \InvalidArgumentException('non-nullable account_number_last4 cannot be null');
        }
