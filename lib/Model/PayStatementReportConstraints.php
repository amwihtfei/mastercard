...
/**
 * PayStatementReportConstraints Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PayStatementReportConstraints implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PayStatementReportConstraints';
    ...
    protected static $openAPITypes = [
        'paystatement_report' => '\OpenAPI\Client\Model\PayStatementData',
    ...
    protected static $setters = [
        'paystatement_report' => 'setPaystatementReport',
    ...
    protected static $getters = [
        'paystatement_report' => 'getPaystatementReport',
    ...
    {
        $this->setIfExists('paystatement_report', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['paystatement_report'] === null) {
            $invalidProperties[] = "'paystatement_report' can't be null";
        }
    ...
    /**
     * Gets paystatement_report
     *
     * @return \OpenAPI\Client\Model\PayStatementData
     */
    public function getPaystatementReport()
    {
        return $this->container['paystatement_report'];
    }

    /**
     * Sets paystatement_report
     *
     * @param \OpenAPI\Client\Model\PayStatementData $paystatement_report paystatement_report
     *
     * @return self
     */
    public function setPaystatementReport($paystatement_report)
    {
        if (is_null($paystatement_report)) {
            throw new \InvalidArgumentException('non-nullable paystatement_report cannot be null');
        }
        $this->container['paystatement_report'] = $paystatement_report;
