...
/**
 * CashFlowAnalyticsReport Class Doc Comment
 *
 * @category Class
 ...
 */
class CashFlowAnalyticsReport implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CashFlowAnalyticsReport';
    ...
    protected static $openAPITypes = [
        'account_results' => '\OpenAPI\Client\Model\CashFlowAnalyticsAccountResult[]',
        'business_id' => 'int',
        'business_summary' => '\OpenAPI\Client\Model\CashFlowAnalyticsBusinessSummary',
        'customer_id' => 'int',
    ...
    */
     ...
     *
     * @return \OpenAPI\Client\Model\CashFlowAnalyticsAccountResult[]|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\CashFlowAnalyticsAccountResult[]|null $account_results Cash flow results per account
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\CashFlowAnalyticsBusinessSummary|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\CashFlowAnalyticsBusinessSummary|null $business_summary business_summary
     *
     * @return self
     */
    ...
    public function setRequesterName($requester_name)
    {
        ...
        if ((mb_strlen($requester_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $requester_name when calling CashFlowAnalyticsReport., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($requester_name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $requester_name when calling CashFlowAnalyticsReport., must be bigger than or equal to 0.');
        }
