...
/**
 * ObbDateRangeAndAmount Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ObbDateRangeAndAmount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ObbDateRangeAndAmount';
    ...
    */
     ...
     * Sets amount
     *
     * @param float|null $amount Metric value for the given period
     *
     * @return self
     */
    ...
    public function setPeriod($period)
    {
        ...
        if ((mb_strlen($period) > 12)) {
            throw new \InvalidArgumentException('invalid length for $period when calling ObbDateRangeAndAmount., must be smaller than or equal to 12.');
        }
        if ((mb_strlen($period) < 8)) {
            throw new \InvalidArgumentException('invalid length for $period when calling ObbDateRangeAndAmount., must be bigger than or equal to 8.');
        }
    ...
    public function setPeriodBeginDate($period_begin_date)
    {
        ...
        if ((mb_strlen($period_begin_date) > 10)) {
            throw new \InvalidArgumentException('invalid length for $period_begin_date when calling ObbDateRangeAndAmount., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($period_begin_date) < 10)) {
            throw new \InvalidArgumentException('invalid length for $period_begin_date when calling ObbDateRangeAndAmount., must be bigger than or equal to 10.');
        }
    ...
    public function setPeriodEndDate($period_end_date)
    {
        ...
        if ((mb_strlen($period_end_date) > 10)) {
            throw new \InvalidArgumentException('invalid length for $period_end_date when calling ObbDateRangeAndAmount., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($period_end_date) < 10)) {
            throw new \InvalidArgumentException('invalid length for $period_end_date when calling ObbDateRangeAndAmount., must be bigger than or equal to 10.');
        }
