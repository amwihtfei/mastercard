 ...
 */
class NetMonthly implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NetMonthly';
    ...
    */
     ...
     * Sets month
     *
     * @param int $month Timestamp for the first day of this month
     *
     * @return self
     */
     ...
     * Sets net
     *
     * @param float $net Total income during the given month, across all income streams
     *
     * @return self
     */
