...
/**
 * CashFlowCashFlowCharacteristicsSummary Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CashFlowCashFlowCharacteristicsSummary implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CashFlowCashFlowCharacteristicsSummary';
    ...
    protected static $openAPITypes = [
        'monthly_cash_flow_characteristics_summaries' => '\OpenAPI\Client\Model\CashFlowMonthlyCashFlowCharacteristicsSummaries[]',
    ...
    protected static array $openAPINullables = [
        'monthly_cash_flow_characteristics_summaries' => false,
    ...
    protected static $setters = [
        'monthly_cash_flow_characteristics_summaries' => 'setMonthlyCashFlowCharacteristicsSummaries',
    ...
    protected static $getters = [
        'monthly_cash_flow_characteristics_summaries' => 'getMonthlyCashFlowCharacteristicsSummaries',
    ...
    {
        $this->setIfExists('monthly_cash_flow_characteristics_summaries', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['twelve_month_total_net'] === null) {
            $invalidProperties[] = "'twelve_month_total_net' can't be null";
        }
        if ($this->container['twelve_month_total_net_less_transfers'] === null) {
            $invalidProperties[] = "'twelve_month_total_net_less_transfers' can't be null";
        }
        if ($this->container['six_month_average_total_credits_less_total_debits'] === null) {
            $invalidProperties[] = "'six_month_average_total_credits_less_total_debits' can't be null";
        }
        if ($this->container['six_month_average_total_credits_less_total_debits_less_transfers'] === null) {
            $invalidProperties[] = "'six_month_average_total_credits_less_total_debits_less_transfers' can't be null";
        }
        if ($this->container['two_month_average_total_credits_less_total_debits'] === null) {
            $invalidProperties[] = "'two_month_average_total_credits_less_total_debits' can't be null";
        }
    ...
    /**
     * Gets monthly_cash_flow_characteristics_summaries
     *
     * @return \OpenAPI\Client\Model\CashFlowMonthlyCashFlowCharacteristicsSummaries[]|null
     */
    public function getMonthlyCashFlowCharacteristicsSummaries()
    {
        return $this->container['monthly_cash_flow_characteristics_summaries'];
    }

    /**
     * Sets monthly_cash_flow_characteristics_summaries
     *
     * @param \OpenAPI\Client\Model\CashFlowMonthlyCashFlowCharacteristicsSummaries[]|null $monthly_cash_flow_characteristics_summaries List of attributes for each month
     *
     * @return self
     */
    public function setMonthlyCashFlowCharacteristicsSummaries($monthly_cash_flow_characteristics_summaries)
    {
        if (is_null($monthly_cash_flow_characteristics_summaries)) {
            throw new \InvalidArgumentException('non-nullable monthly_cash_flow_characteristics_summaries cannot be null');
        }
        $this->container['monthly_cash_flow_characteristics_summaries'] = $monthly_cash_flow_characteristics_summaries;
     ...
     *
     * @param float $average_monthly_net Average monthly net amount
     *
     * @return self
     */
     ...
     *
     * @param float $average_monthly_net_less_transfers Average monthly net less transfers
     *
     * @return self
     */
     ...
     *
     * @param float $twelve_month_total_net Sum of all monthly (Total Credits - Total Debits) each month by the account
     *
     * @return self
     */
     ...
     *
     * @param float $twelve_month_total_net_less_transfers Sum of all monthly (Total Credits - Total Debits) without transfers by the account
     *
     * @return self
     */
     ...
     *
     * @param float $six_month_average_total_credits_less_total_debits 6 Month Average (Total Credits - Total Debits) across all accounts
     *
     * @return self
     */
     ...
     *
     * @param float $six_month_average_total_credits_less_total_debits_less_transfers 6 Month Average (Total Credits - Total Debits) - (Without Transfers) across all accounts
     *
     * @return self
     */
     ...
     *
     * @param float $two_month_average_total_credits_less_total_debits 2 Month Average (Total Credits - Total Debits) across all accounts
     *
     * @return self
     */
     ...
     *
     * @param float|null $two_month_average_total_credits_less_total_debits_less_transfers 2 Month Average (Total Credits - Total Debits) - (Without Transfers) across all accounts
     *
     * @return self
     */
