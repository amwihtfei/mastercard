...
/**
 * LoanPaymentDetails Class Doc Comment
 *
 * @category Class
 ...
 */
class LoanPaymentDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LoanPaymentDetails';
    ...
    protected static $openAPITypes = [
        ...
        'account_detail' => '\OpenAPI\Client\Model\LoanPaymentDetailsAccount'
    ];
    ...
    */
     ...
     * Sets loan_number
     *
     * @param string $loan_number The number of the specific loan under the account.
     *
     * @return self
     */
     ...
     *
     * @param string $loan_payment_address The payment address to send manual payments to
     *
     * @return self
     */
     ...
     * Gets account_detail
     *
     * @return \OpenAPI\Client\Model\LoanPaymentDetailsAccount|null
     */
     ...
     * Sets account_detail
     *
     * @param \OpenAPI\Client\Model\LoanPaymentDetailsAccount|null $account_detail account_detail
     *
     * @return self
     */
    public function setAccountDetail($account_detail)
    {
        if (is_null($account_detail)) {
            throw new \InvalidArgumentException('non-nullable account_detail cannot be null');
        }
