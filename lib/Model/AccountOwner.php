...
class AccountOwner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets owner_name
     *
     * @param string $owner_name The name of the account owner. Can be multiple account owners in one string. This is how the source data is returned from the institution.
     *
     * @return self
     */
     ...
     * Sets owner_address
     *
     * @param string $owner_address A street address
     *
     * @return self
     */
     ...
     * Sets as_of_date
     *
     * @param int|null $as_of_date A date in Unix epoch time (in seconds). See: [Handling Epoch Dates and Times](https://developer.mastercard.com/open-banking-us/documentation/codes-and-formats/).
     *
     * @return self
     */
