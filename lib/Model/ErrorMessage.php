...
class ErrorMessage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets code
     *
     * @param object $code An error code (can be returned as a number or a string). Useful links: [Common API Status Codes](https://developer.mastercard.com/open-banking-us/documentation/codes-and-formats/#common-api-status-codes), [Aggregation Status Codes](https://developer.mastercard.com/open-banking-us/documentation/products/manage/account-aggregation/#aggregation-status-codes).
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string|null $status A status code
     *
     * @return self
     */
     ...
     * Sets title
     *
     * @param string|null $title A title for the error
     *
     * @return self
     */
     ...
     * Sets level
     *
     * @param string|null $level An error level
     *
     * @return self
     */
     ...
     * Sets user_message
     *
     * @param string|null $user_message Some more details about the error
     *
     * @return self
     */
