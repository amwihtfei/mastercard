...
/**
 * CertifiedInstitutions Class Doc Comment
 *
 * @category Class
 ...
 */
class CertifiedInstitutions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CertifiedInstitutions';
    ...
    protected static $openAPITypes = [
        ...
        'more_available' => 'bool',
        'requested_date' => 'int',
        'institutions' => '\OpenAPI\Client\Model\CertifiedInstitution[]'
    ];
    ...
    */
     ...
     * Sets requested_date
     *
     * @param int $requested_date A date in Unix epoch time (in seconds). See: [Handling Epoch Dates and Times](https://developer.mastercard.com/open-banking-us/documentation/codes-and-formats/).
     *
     * @return self
     */
     ...
     * Gets institutions
     *
     * @return \OpenAPI\Client\Model\CertifiedInstitution[]
     */
     ...
     * Sets institutions
     *
     * @param \OpenAPI\Client\Model\CertifiedInstitution[] $institutions A list of institutions
     *
     * @return self
     */
    public function setInstitutions($institutions)
    {
        ...
        if ((count($institutions) > 1000)) {
            throw new \InvalidArgumentException('invalid value for $institutions when calling CertifiedInstitutions., number of items must be less than or equal to 1000.');
        }
        if ((count($institutions) < 0)) {
            throw new \InvalidArgumentException('invalid length for $institutions when calling CertifiedInstitutions., number of items must be greater than or equal to 0.');
        }
