...
class Receiver implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets routing_number
     *
     * @param string $routing_number Routing number of receiving bank
     *
     * @return self
     */
     ...
     * Sets account_number
     *
     * @param string $account_number Micro entries receiving account number of bank
     *
     * @return self
     */
     ...
     * Sets account_type
     *
     * @param string $account_type The list of supported account types. * \"checking\": Standard checking * \"savings\": Standard savings
     *
     * @return self
     */
     ...
     * Sets memo
     *
     * @param string|null $memo Transaction memo to be displayed for transactions
     *
     * @return self
     */
