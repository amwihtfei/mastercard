...
/**
 * PrequalificationReportAccount Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PrequalificationReportAccount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PrequalificationReportAccount';
    ...
    protected static $openAPIFormats = [
        ...
        'tot_number_insufficient_funds_fee_debit_tx_account' => 'int32',
    ...
    */
     ...
     * Sets owner_name
     *
     * @param string|null $owner_name The name of the account owner. If no owner information is available, this field won't appear in the report.
     *
     * @return self
     */
     ...
     * Sets owner_address
     *
     * @param string|null $owner_address The mailing address of the account owner. If no owner information is available, this field won't appear in the report.
     *
     * @return self
     */
     ...
     * Sets balance_date
     *
     * @param int|null $balance_date A timestamp of the balance
     *
     * @return self
     */
     ...
     *
     * @param float|null $average_monthly_balance The average monthly balance of the account
     *
     * @return self
     */
     ...
     *
     * @param int|null $tot_number_days_since_most_recent_insufficient_funds_fee_debit_tx_account The total number of days since the most recent insufficient funds fee for the account
     *
     * @return self
     */
