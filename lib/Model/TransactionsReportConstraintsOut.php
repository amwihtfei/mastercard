...
/**
 * TransactionsReportConstraintsOut Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TransactionsReportConstraintsOut implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TransactionsReportConstraintsOut';
    ...
    protected static $setters = [
        ...
        'to_date' => 'setToDate',
        'include_pending' => 'setIncludePending',
    ...
    protected static $getters = [
        ...
        'to_date' => 'getToDate',
        'include_pending' => 'getIncludePending',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('include_pending', $data ?? [], false);
    ...
    */
     ...
     * Sets to_date
     *
     * @param int|null $to_date A date in Unix epoch time (in seconds). See: [Handling Epoch Dates and Times](https://developer.mastercard.com/open-banking-us/documentation/codes-and-formats/).
     *
     * @return self
     */
    ...
    /**
     * Gets include_pending
     *
     * @return bool|null
     */
    public function getIncludePending()
    {
        return $this->container['include_pending'];
    }

    /**
     * Sets include_pending
     *
     * @param bool|null $include_pending If pending transactions must be included
     *
     * @return self
     */
    public function setIncludePending($include_pending)
    {
        if (is_null($include_pending)) {
            throw new \InvalidArgumentException('non-nullable include_pending cannot be null');
        }
        $this->container['include_pending'] = $include_pending;
