...
/**
 * MicroEntryVerifyRequestParameter Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class MicroEntryVerifyRequestParameter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MicroEntryVerifyRequestParameter';
    ...
    */
     ...
     * Sets customer_id
     *
     * @param string|null $customer_id A customer ID. See Add Customer API for how to create a customer ID.
     *
     * @return self
     */
